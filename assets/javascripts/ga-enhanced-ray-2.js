...
(function () {
    ...
    // --- Web Vitals Library ---
    var webVitals = function (e) { /* ... (UNCHANGED MINIFIED webVitals code from previous answer) ... */
    ...
    const piiPatterns = { /* ... (UNCHANGED piiPatterns object from previous answer) ... */
    ...
    function redactPii(text, level = config.piiRedactionLevel) { /* ... (UNCHANGED redactPii function) ... */
    ...
    function scrubUrlParams(url) { /* ... (UNCHANGED scrubUrlParams function) ... */
    ...
    // --- GA Helper Functions ---
    function sendGAEvent(eventName, eventParams = {}) { /* ... (UNCHANGED sendGAEvent function, including PII redaction for specific keys) ... */
    ...
    function sendGAPageView(path = null, title = null) { /* ... (UNCHANGED sendGAPageView function) ... */
        if (typeof gtag === 'function' && GA_MEASUREMENT_ID) {
    ...
    function setGAUserProperty(propName, propValue) { /* ... (UNCHANGED setGAUserProperty function) ... */
    ...
    function initAutoLinkTracking() { /* ... (UNCHANGED initAutoLinkTracking function from previous answer) ... */
    ...
    function initHtmlMediaTracking() { /* ... (UNCHANGED initHtmlMediaTracking function from previous, including milestone fixes) ... */
    ...
    function initVimeoTracking() { /* ... (UNCHANGED initVimeoTracking function from previous answer, ensure milestones and complete logic are aligned if modifying) ... */
    ...
    function initTwitterTracking() { /* ... (UNCHANGED initTwitterTracking function from previous answer) ... */
    ...
    function initScrollTracking() { /* ... (UNCHANGED initScrollTracking function from previous answer) ... */
    ...
    function initWebVitalsTracking() { /* ... (UNCHANGED initWebVitalsTracking function from previous answer) ... */
    ...
    function initAdblockDetection() { /* ... (UNCHANGED initAdblockDetection function) ... */
    ...
    function handleSearchTermCheck(currentUrl = window.location.href) { /* ... (UNCHANGED handleSearchTermCheck function) ... */
    ...
    function initSpaTracking() { /* ... (UNCHANGED initSpaTracking function, including resets for scroll/adblock and re-init for dynamic YT/HTML5/Vimeo/Twitter) ... */
